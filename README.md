...
| `direction`   | `string`  | `vertical`       | `vertical` or `horizontal`                                                                                                                                                                           |     | `horizontal` Scroll direction: If horizontal, avoid to set section width in any value other than `auto` in order to create a container that is bigger than the viewport. |
