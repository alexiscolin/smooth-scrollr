...
| `scrollOf`    | In order to scroll from a specific number of pixel.                | `path` : *(number)* - the distance in px you want the page go through<br>- `imediate` : *(boolean - default: false)* with/without smooth effect                                                                                                                                                                                                 |
